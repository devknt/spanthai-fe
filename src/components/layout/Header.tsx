        ...
        <div className="container">
          <div className="w-full py-4 mx-auto lg:flex md:justify-between md:items-center">
            <div className="flex items-center justify-between w-full">
              <Link
                href="/"
                className="flex items-center justify-center gap-2 text-3xl font-semibold text-neutral-100"
              >
                {/* <LogoSVG width={50} height={50} /> */}
                <span className="flex gap-1">
                  <span className="text-white font-brush">Span</span>
                  <span className="text-primary-500 font-brush">Thai</span>
                </span>
              </Link>
