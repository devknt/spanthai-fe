          ...
          <div className="flex flex-col items-center gap-16 md:grid md:grid-cols-2">
            ...
            >
              ...
              <p className="text-base">
                SpanThai has been a home for genuine Spanish and Thai cooking for a
                decade. We started out with a love for true Spanish and Thai flavors and
                a wish to bring them to everyone. Our chefs, known for their
                careful craft and commitment, put together dishes that truly
                reflect the heart of Spain and Thailand&apos;s cooking traditions.
              </p>
